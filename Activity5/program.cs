...
static void Add()
 {
 string filepath = @"D:\FPAct8_(Ader,Gladys Joy F.)\BoardMarker.txt";
...
Console.Write("Enter the bm number: ");
 ...
 i--;
 Console.WriteLine("Boardmarker name: {0}", names[i]);
 Console.WriteLine("Boardmarker inkColor: {0}", colors[i]);
 Console.WriteLine("Boardmarker inkContent: {0}", contents[i]);
